...
export class PageLive extends ViewPU {
    ...
    setInitiallyProvidedValue(params: PageLive_Params) {
    }
    updateStateVars(params: PageLive_Params) {
    }
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777226, "type": 10003, params: [], "bundleName": "com.example.swiperarkts", "moduleName": "entry" });

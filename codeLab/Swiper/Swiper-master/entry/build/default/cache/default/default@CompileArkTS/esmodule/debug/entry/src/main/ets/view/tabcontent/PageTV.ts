...
export class PageTV extends ViewPU {
    ...
    setInitiallyProvidedValue(params: PageTV_Params) {
    }
    updateStateVars(params: PageTV_Params) {
    }
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777220, "type": 10003, params: [], "bundleName": "com.example.swiperarkts", "moduleName": "entry" });
